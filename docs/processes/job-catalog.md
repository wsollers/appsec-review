...
Covers 5 process models, 40 steps (operator scripts, human tasks, standalone Dagster jobs and ops), 51 lifecycle jobs and 88 artifacts.
...
### Engagement flow: 3. Build configure
...
| **Group rollup** | | **Enters:** [`artifact-manifest`](#a-artifact-manifest)<br>[`00-intake`](#a-job-00-intake)<br>[`buildenv-image`](#a-buildenv-image)<br>[`02-dev-project-discovery`](#a-job-02-dev-project-discovery) | **Leaves:** [`workflow-status`](#a-workflow-status)<br>[`build-execution`](#a-build-execution)<br>[`02-build-configure`](#a-job-02-build-configure) |
...
| Rolled up for the model | Artifacts |
|---|---|
| Enters | [`docker-engine`](#a-docker-engine)<br>[`host-dirs`](#a-host-dirs)<br>[`job-definitions`](#a-job-definitions)<br>[`sut-origin`](#a-sut-origin)<br>[`sut-pin`](#a-sut-pin)<br>[`engagement-definition`](#a-engagement-definition)<br>[`permission-grant`](#a-permission-grant)<br>[`partition-record`](#a-partition-record)<br>[`dev-record`](#a-dev-record) |
| Leaves | [`code-location-venv`](#a-code-location-venv)<br>[`resolved-config`](#a-resolved-config)<br>[`partition-handoff`](#a-partition-handoff)<br>[`dev-handoff`](#a-dev-handoff)<br>[`02-build-configure`](#a-job-02-build-configure) |
| Passes between steps | [`dagster-services`](#a-dagster-services)<br>[`code-location`](#a-code-location)<br>[`compose-env`](#a-compose-env)<br>[`loaded-job-list`](#a-loaded-job-list)<br>[`sut-checkout`](#a-sut-checkout)<br>[`run-dir`](#a-run-dir)<br>[`artifact-manifest`](#a-artifact-manifest)<br>[`00-intake`](#a-job-00-intake)<br>[`02-repository-partition-discovery`](#a-job-02-repository-partition-discovery)<br>[`partition-supplied`](#a-partition-supplied)<br>[`dev-supplied`](#a-dev-supplied)<br>[`02-dev-project-discovery`](#a-job-02-dev-project-discovery) |
...
### Fixture bring-up: S6 Build configure (blocked)
...
| Consumed by | [`dev_project_discovery`](#step-dev-project-discovery)<br>[`dev-analysis`](#step-dev-analysis)<br>[`02-dev-project-discovery`](#job-02-dev-project-discovery)<br>[`02-devops-project-discovery`](#job-02-devops-project-discovery)<br>[`02-sre-operations-topology`](#job-02-sre-operations-topology) |
...
| <a id="a-permission-grant"></a>`permission-grant` | decision | named human approval | [`grant-permissions`](#step-grant-permissions) | [`stage-artifacts`](#step-stage-artifacts) |
...
| <a id="a-buildenv-image"></a>`buildenv-image` | state | audit-buildenv-cpp (pinned image, via B13) | -- | [`build_execution`](#step-build-execution) |
