...
Covers 5 process models, 50 steps (operator scripts, human tasks, standalone Dagster jobs and ops), 52 lifecycle jobs and 103 artifacts.
...
| Leaves | [`code-location-venv`](#a-code-location-venv)<br>[`prep-scope`](#a-prep-scope)<br>[`prep-native-plan`](#a-prep-native-plan)<br>[`prep-handoffs`](#a-prep-handoffs)<br>[`workflow-status`](#a-workflow-status)<br>[`02-build-index`](#a-job-02-build-index)<br>[`build-attempts`](#a-build-attempts)<br>[`build-lock`](#a-build-lock)<br>[`build-execution`](#a-build-execution)<br>[`lane-handoff`](#a-lane-handoff)<br>[`10-synthesis-report`](#a-job-10-synthesis-report) |
...
| **Group rollup** | | **Enters:** [`00-intake`](#a-job-00-intake)<br>[`02-repository-partition-discovery`](#a-job-02-repository-partition-discovery)<br>[`02-dev-project-discovery`](#a-job-02-dev-project-discovery)<br>[`02-devops-project-discovery`](#a-job-02-devops-project-discovery)<br>[`sut-checkout`](#a-sut-checkout)<br>[`buildenv-catalog`](#a-buildenv-catalog)<br>[`llm-invoker`](#a-llm-invoker)<br>[`permission-grant`](#a-permission-grant)<br>[`buildenv-image`](#a-buildenv-image)<br>[`artifact-manifest`](#a-artifact-manifest) | **Leaves:** [`02-build-index`](#a-job-02-build-index)<br>[`build-attempts`](#a-build-attempts)<br>[`build-lock`](#a-build-lock)<br>[`workflow-status`](#a-workflow-status)<br>[`build-execution`](#a-build-execution)<br>[`02-build-configure`](#a-job-02-build-configure) |
...
| Rolled up for the model | Artifacts |
|---|---|
| Enters | [`docker-engine`](#a-docker-engine)<br>[`host-dirs`](#a-host-dirs)<br>[`job-definitions`](#a-job-definitions)<br>[`sut-origin`](#a-sut-origin)<br>[`sut-pin`](#a-sut-pin)<br>[`engagement-definition`](#a-engagement-definition)<br>[`permission-grant`](#a-permission-grant)<br>[`dispatch-mode`](#a-dispatch-mode)<br>[`partition-record`](#a-partition-record)<br>[`dev-record`](#a-dev-record)<br>[`02-devops-project-discovery`](#a-job-02-devops-project-discovery)<br>[`buildenv-catalog`](#a-buildenv-catalog)<br>[`llm-invoker`](#a-llm-invoker)<br>[`buildenv-image`](#a-buildenv-image) |
| Leaves | [`code-location-venv`](#a-code-location-venv)<br>[`resolved-config`](#a-resolved-config)<br>[`partition-handoff`](#a-partition-handoff)<br>[`dev-handoff`](#a-dev-handoff)<br>[`02-build-index`](#a-job-02-build-index)<br>[`build-attempts`](#a-build-attempts)<br>[`build-lock`](#a-build-lock)<br>[`02-build-configure`](#a-job-02-build-configure) |
...
| [02-build-plan (designed)](#step-build-plan) | designed, not built | [`build-index`](#a-build-index)<br>[`buildenv-catalog`](#a-buildenv-catalog)<br>[`llm-invoker`](#a-llm-invoker) | [`build-plan`](#a-build-plan) |
| [02-build-resolution (designed)](#step-build-resolution) | designed, not built | [`build-plan`](#a-build-plan)<br>[`build-image-catalog`](#a-build-image-catalog)<br>[`permission-grant`](#a-permission-grant)<br>[`buildenv-image`](#a-buildenv-image)<br>[`llm-invoker`](#a-llm-invoker) | [`build-attempts`](#a-build-attempts)<br>[`build-image-catalog`](#a-build-image-catalog)<br>[`build-lock`](#a-build-lock) |
| **Group rollup** | | **Enters:** [`00-intake`](#a-job-00-intake)<br>[`02-repository-partition-discovery`](#a-job-02-repository-partition-discovery)<br>[`02-dev-project-discovery`](#a-job-02-dev-project-discovery)<br>[`02-devops-project-discovery`](#a-job-02-devops-project-discovery)<br>[`sut-checkout`](#a-sut-checkout)<br>[`buildenv-catalog`](#a-buildenv-catalog)<br>[`llm-invoker`](#a-llm-invoker)<br>[`permission-grant`](#a-permission-grant)<br>[`buildenv-image`](#a-buildenv-image) | **Leaves:** [`02-build-index`](#a-job-02-build-index)<br>[`build-attempts`](#a-build-attempts)<br>[`build-lock`](#a-build-lock) |
...
|---|---|
| Enters | [`artifact-manifest`](#a-artifact-manifest) |
| Leaves | [`02-build-index`](#a-job-02-build-index)<br>[`10-synthesis-report`](#a-job-10-synthesis-report) |
...
| <a id="a-build-index"></a>`build-index` | file | runs/<run_id>/data/jobs/02-build-index/attempts/<attempt_id>/build-index.json, build-index.md | [`build-index`](#step-build-index) | [`build-plan`](#step-build-plan) |
...
| <a id="a-job-02-build-index"></a>`02-build-index` | job output | runs/<run_id>/data/jobs/02-build-index/ | [`build-index`](#step-build-index)<br>[`02-build-index`](#job-02-build-index) | -- |
