...
Covers 5 process models, 51 steps (operator scripts, human tasks, standalone Dagster jobs and ops), 53 lifecycle jobs and 105 artifacts.
...
| Step | Type | Consumes | Produces |
|---|---|---|---|
| [build_index (Dagster job)](#step-build-index) | Dagster job | [`00-intake`](#a-job-00-intake)<br>[`02-repository-partition-discovery`](#a-job-02-repository-partition-discovery)<br>[`02-dev-project-discovery`](#a-job-02-dev-project-discovery)<br>[`02-devops-project-discovery`](#a-job-02-devops-project-discovery)<br>[`sut-checkout`](#a-sut-checkout) | [`02-build-index`](#a-job-02-build-index)<br>[`build-index`](#a-build-index) |
| [build_classify (Dagster job)](#step-build-classify) | Dagster job | [`02-build-index`](#a-job-02-build-index)<br>[`build-index`](#a-build-index)<br>[`sut-checkout`](#a-sut-checkout)<br>[`llm-invoker`](#a-llm-invoker) | [`02-build-classify`](#a-job-02-build-classify)<br>[`build-classification`](#a-build-classification) |
| [02-build-plan (designed)](#step-build-plan) | designed, not built | [`build-index`](#a-build-index)<br>[`build-classification`](#a-build-classification)<br>[`buildenv-catalog`](#a-buildenv-catalog)<br>[`sut-checkout`](#a-sut-checkout)<br>[`llm-invoker`](#a-llm-invoker) | [`build-plan`](#a-build-plan) |
...
| **Group rollup** | | **Enters:** [`00-intake`](#a-job-00-intake)<br>[`02-repository-partition-discovery`](#a-job-02-repository-partition-discovery)<br>[`02-dev-project-discovery`](#a-job-02-dev-project-discovery)<br>[`02-devops-project-discovery`](#a-job-02-devops-project-discovery)<br>[`sut-checkout`](#a-sut-checkout)<br>[`llm-invoker`](#a-llm-invoker)<br>[`buildenv-catalog`](#a-buildenv-catalog)<br>[`permission-grant`](#a-permission-grant)<br>[`buildenv-image`](#a-buildenv-image)<br>[`artifact-manifest`](#a-artifact-manifest) | **Leaves:** [`02-build-classify`](#a-job-02-build-classify)<br>[`build-attempts`](#a-build-attempts)<br>[`build-lock`](#a-build-lock)<br>[`workflow-status`](#a-workflow-status)<br>[`build-execution`](#a-build-execution)<br>[`02-build-configure`](#a-job-02-build-configure) |
...
| [Build Index](#job-02-build-index) | lifecycle job | [`00-intake`](#a-job-00-intake)<br>[`02-repository-partition-discovery`](#a-job-02-repository-partition-discovery)<br>[`02-dev-project-discovery`](#a-job-02-dev-project-discovery)<br>[`02-devops-project-discovery`](#a-job-02-devops-project-discovery) | [`02-build-index`](#a-job-02-build-index) |
| [Build Unit Classification](#job-02-build-classify) | lifecycle job | [`02-build-index`](#a-job-02-build-index) | [`02-build-classify`](#a-job-02-build-classify) |
...
| Rolled up for the model | Artifacts |
|---|---|
| Enters | [`docker-engine`](#a-docker-engine)<br>[`host-dirs`](#a-host-dirs)<br>[`job-definitions`](#a-job-definitions)<br>[`sut-origin`](#a-sut-origin)<br>[`sut-pin`](#a-sut-pin)<br>[`engagement-definition`](#a-engagement-definition)<br>[`permission-grant`](#a-permission-grant)<br>[`dispatch-mode`](#a-dispatch-mode)<br>[`partition-record`](#a-partition-record)<br>[`dev-record`](#a-dev-record)<br>[`02-devops-project-discovery`](#a-job-02-devops-project-discovery)<br>[`llm-invoker`](#a-llm-invoker)<br>[`buildenv-catalog`](#a-buildenv-catalog)<br>[`buildenv-image`](#a-buildenv-image) |
| Leaves | [`code-location-venv`](#a-code-location-venv)<br>[`resolved-config`](#a-resolved-config)<br>[`partition-handoff`](#a-partition-handoff)<br>[`dev-handoff`](#a-dev-handoff)<br>[`02-build-classify`](#a-job-02-build-classify)<br>[`build-attempts`](#a-build-attempts)<br>[`build-lock`](#a-build-lock)<br>[`02-build-configure`](#a-job-02-build-configure) |
| Passes between steps | [`dagster-services`](#a-dagster-services)<br>[`code-location`](#a-code-location)<br>[`compose-env`](#a-compose-env)<br>[`loaded-job-list`](#a-loaded-job-list)<br>[`sut-checkout`](#a-sut-checkout)<br>[`run-dir`](#a-run-dir)<br>[`artifact-manifest`](#a-artifact-manifest)<br>[`00-intake`](#a-job-00-intake)<br>[`02-repository-partition-discovery`](#a-job-02-repository-partition-discovery)<br>[`partition-supplied`](#a-partition-supplied)<br>[`dev-supplied`](#a-dev-supplied)<br>[`02-dev-project-discovery`](#a-job-02-dev-project-discovery)<br>[`02-build-index`](#a-job-02-build-index)<br>[`build-index`](#a-build-index)<br>[`build-classification`](#a-build-classification)<br>[`build-plan`](#a-build-plan)<br>[`build-image-catalog`](#a-build-image-catalog) |
...
| [02-build-plan (designed)](#step-build-plan) | designed, not built | [`build-index`](#a-build-index)<br>[`build-classification`](#a-build-classification)<br>[`buildenv-catalog`](#a-buildenv-catalog)<br>[`sut-checkout`](#a-sut-checkout)<br>[`llm-invoker`](#a-llm-invoker) | [`build-plan`](#a-build-plan) |
| [02-build-resolution (designed)](#step-build-resolution) | designed, not built | [`build-plan`](#a-build-plan)<br>[`build-image-catalog`](#a-build-image-catalog)<br>[`permission-grant`](#a-permission-grant)<br>[`buildenv-image`](#a-buildenv-image)<br>[`llm-invoker`](#a-llm-invoker) | [`build-attempts`](#a-build-attempts)<br>[`build-image-catalog`](#a-build-image-catalog)<br>[`build-lock`](#a-build-lock) |
| **Group rollup** | | **Enters:** [`00-intake`](#a-job-00-intake)<br>[`02-repository-partition-discovery`](#a-job-02-repository-partition-discovery)<br>[`02-dev-project-discovery`](#a-job-02-dev-project-discovery)<br>[`02-devops-project-discovery`](#a-job-02-devops-project-discovery)<br>[`sut-checkout`](#a-sut-checkout)<br>[`llm-invoker`](#a-llm-invoker)<br>[`buildenv-catalog`](#a-buildenv-catalog)<br>[`permission-grant`](#a-permission-grant)<br>[`buildenv-image`](#a-buildenv-image) | **Leaves:** [`02-build-classify`](#a-job-02-build-classify)<br>[`build-attempts`](#a-build-attempts)<br>[`build-lock`](#a-build-lock) |
...
### build_index (Dagster job)

| | |
|---|---|
| Type | Dagster job |
| Runs | `launch_job.py --run-id <run_id> --job build_index --wait` |
| Lifecycle job(s) | [`02-build-index`](#job-02-build-index) |
| Consumes | [`00-intake`](#a-job-00-intake)<br>[`02-repository-partition-discovery`](#a-job-02-repository-partition-discovery)<br>[`02-dev-project-discovery`](#a-job-02-dev-project-discovery)<br>[`02-devops-project-discovery`](#a-job-02-devops-project-discovery)<br>[`sut-checkout`](#a-sut-checkout) |
| Produces | [`02-build-index`](#a-job-02-build-index)<br>[`build-index`](#a-build-index) |
| Notes | build_index.py (built 2026-09-25): deterministic indexer on the common envelope. Enumerates candidate units (one per build root: dir:<root>, or file:<Dockerfile\|compose>), places nested and vendored roots as members or not-units with a cited reason, and collects cited build signals (build systems, toolchain and dependency declarations, CI and Dockerfile recipes, README build text, JS/TS markers) under 400 signals / 4 KiB excerpts / 512 KiB, every omission counted. Assigns no class. Executes nothing. docs/processes/build-resolution.md, ADR-0012 revision 1. |

<a id="step-build-classify"></a>

### build_classify (Dagster job)

| | |
|---|---|
| Type | Dagster job |
| Runs | `launch_job.py --run-id <run_id> --job build_classify --wait` |
| Lifecycle job(s) | [`02-build-classify`](#job-02-build-classify) |
| Consumes | [`02-build-index`](#a-job-02-build-index)<br>[`build-index`](#a-build-index)<br>[`sut-checkout`](#a-sut-checkout)<br>[`llm-invoker`](#a-llm-invoker) |
| Produces | [`02-build-classify`](#a-job-02-build-classify)<br>[`build-classification`](#a-build-classification) |
| Notes | build_classify.py (built 2026-09-25, ADR-0012 revision 2): one claude-sonnet-5/medium persona call reads the whole checkout and the accepted build index, gives every index unit one cited class (mixed units split into parts), and records where the index is wrong (index_review, never applied). The orchestrator sets source_revision, index, build_set and citation hashes; every unit covered exactly once, signal ids and citations checked before publication. |
...
| Consumes | [`build-index`](#a-build-index)<br>[`build-classification`](#a-build-classification)<br>[`buildenv-catalog`](#a-buildenv-catalog)<br>[`sut-checkout`](#a-sut-checkout)<br>[`llm-invoker`](#a-llm-invoker) |
...
| Consumed by | [`build-index`](#step-build-index)<br>[`02-build-index`](#job-02-build-index)<br>[`02-evidence-assembly`](#job-02-evidence-assembly)<br>[`02-build-configure`](#job-02-build-configure) |
| Gaps | `not_automatic_analysis_dispatch`, `supplied_result_required` |
| Next prerequisite | Implement the shared persona dispatch runtime while retaining supplied-artifact mode. |
...
#### `02-build-classify` -- Build Unit Classification
...
| <a id="a-llm-invoker"></a>`llm-invoker` | state | PersonaInvoker: claude -p with its current login (subscription, never an API key), model Haiku | -- | [`build-classify`](#step-build-classify)<br>[`build-plan`](#step-build-plan)<br>[`build-resolution`](#step-build-resolution) |
| <a id="a-build-index"></a>`build-index` | file | runs/<run_id>/data/jobs/02-build-index/attempts/<attempt_id>/build-index.json, build-index.md | [`build-index`](#step-build-index) | [`build-classify`](#step-build-classify)<br>[`build-plan`](#step-build-plan) |
| <a id="a-build-classification"></a>`build-classification` | file | runs/<run_id>/data/jobs/02-build-classify/attempts/<attempt_id>/build-classification.json, build-classification-summary.md | [`build-classify`](#step-build-classify) | [`build-plan`](#step-build-plan) |
...
| <a id="a-job-02-dev-project-discovery"></a>`02-dev-project-discovery` | job output | runs/<run_id>/data/jobs/02-dev-project-discovery/ | [`dev_project_discovery`](#step-dev-project-discovery)<br>[`02-dev-project-discovery`](#job-02-dev-project-discovery) | [`build-index`](#step-build-index)<br>[`02-build-index`](#job-02-build-index)<br>[`02-evidence-assembly`](#job-02-evidence-assembly)<br>[`02-build-configure`](#job-02-build-configure) |
...
| <a id="a-job-02-build-classify"></a>`02-build-classify` | job output | runs/<run_id>/data/jobs/02-build-classify/ | [`build-classify`](#step-build-classify)<br>[`02-build-classify`](#job-02-build-classify) | -- |
