...
`0007` (allocator inventory) are unwritten but were reserved by the 2026-09-16 status log and the two
2026-09-14 continuation prompts (all three removed 2026-09-21; this note is now the reservation record). The M01 continuation prompt names
