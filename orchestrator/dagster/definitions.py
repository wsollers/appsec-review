...
from dagster_workflow import engagement_workflow, build_discovery, build_execution, evidence_index, critical_findings_sarif, ossf_scorecard, repository_partition_discovery, dev_project_discovery, devops_project_discovery, sre_operations_topology, build_index, build_classify, full_review, reconcile_workflow_failure, reconcile_workflow_cancellation
...
defs = Definitions(jobs=[orchestration_smoke, nop, phase1_intake, nvd_reference_sync,
                         ...
                         devops_project_discovery, sre_operations_topology, build_index,
                         build_classify, full_review],
